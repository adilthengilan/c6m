          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding: EdgeInsets.symmetric(horizontal: width * 0.01),
                  child: textFormField(controller: jobVacancy.companyNameController, labelText: 'Enter Your Hotel Name'),
                ),
              ...
              Consumer<DashboardProvider>(
                builder: (context, person, child) => 
                jobVacancy.jobLocationType == 2?
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Padding(
                      padding: EdgeInsets.symmetric(horizontal: width * 0.01),
                      child: Text('Do you want to advertise your job in a specific city? *',style: smallTextStyleBold),
                    ),
                    ...
                    ListTile(
                      ...
                      leading: Radio<String>(
                        ...
                        value: 'Yes',
                        groupValue: person.advertiseCityYesorNo,
                        onChanged: (String? value) {
                          person.setAdvertiseCity(value!);
                        },
                      ),
                    ),
                    ListTile(
                      title: const Text('No Anywhere'),
                      leading: Radio<String>(
                        activeColor: Colors.black,
                        value: 'No',
                        groupValue: person.advertiseCityYesorNo,
                    ...
                    if (jobVacancy.advertiseCityYesorNo == 'Yes')
                    Padding(padding: EdgeInsets.symmetric(horizontal: width * 0.01,vertical: height * 0.02),
                    child: textFormField(controller: jobVacancy.jobPlaceAdvertiseController, 
                    labelText: 'Where do you want to advertise this job? *'))
                  ],
                ):
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Padding(
                    padding: EdgeInsets.symmetric(horizontal: width * 0.01),
                    child: Text('Country ', style: smallTextStyleBold),
                  ),
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: width * 0.01),
                    child: textFormField(controller: jobVacancy.jobCountry, labelText: ''),
                  ),
                  sizedBox(height * 0.04, width),
                    Padding(
                    padding: EdgeInsets.symmetric(horizontal: width * 0.01),
                        ...
                        SizedBox(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              textFormField(controller: jobVacancy.jobPinCode, labelText: ''),
                            ],
                          ),
                        ),
                      ],
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Center(
                                    child: IconButton.outlined(
                                      onPressed: () {
                                        person.removeContactDetailes(index);
                                      },
                      ...
                      children: [
                        CustomContainer(
                          ...
                          child: RadioListTile<bool>(
                            ...
                            groupValue: person.jobApplicationDeadlineStatus,
                        ...
                        index == 1 && person.jobApplicationDeadlineStatus ?
                        SizedBox(
                          height: height * 0.048,
                          width: width * 0.14,
                          child: textFormField(
                  ...
                  child: Align(
                    ...
                    child: CustomContainer(
                      ...
                      child: TextButton(
                        ...
                        onPressed: () {
                          jobVacancy.navigateToNextScreen(context);
                        },
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Consumer<DashboardProvider>(
                  builder: (context, person, child) => Column(
                    children: [
                      CustomContainer(
                        boxShadow: person.skillEessentialstatus == 'Required',
                          ...
                          children: [
                            Expanded(
                              child: RadioListTile<String>(
                                ...
                                value: 'Required',
                                groupValue: person.skillEessentialstatus,
                                onChanged: (String? value) {
                      ...
                      sizedBox(height * 0.02, 0.0),
                      CustomContainer(
                        boxShadow: person.skillEessentialstatus == 'Preferred',
                        margin: EdgeInsets.only(right: width * 0.22),
                        border: Border.all(color: Colors.grey.shade300),
                        color: Colors.white,
                        borderRadius: BorderRadius.circular(10),
              ...
              onPressed: index == 0? (){
                  ...
                  jobVacancy.addSkilltoSkillsList(jobVacancy.skillController.text, jobVacancy.skillEessentialstatus,context);
                  
                },
                 child: Text(index == 0? 'Cancel' : 'Add',
...
Widget textFormField({required TextEditingController controller,required String labelText,Widget? sufixIcon}) {
  return CustomTextField(
    ...
    borderRadius: 8,
    borderSide: BorderSide(color: Colors.grey.shade500),
    enabledBorder: BorderSide(color: Colors.grey.shade500),
  );
}
