...
class AccountsManagementScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
              ...
              children: List.generate(2, (index) => Padding(
                ...
                child: Consumer<AccountsManagementProvider>(
                  ...
                  CustomContainer(
                    ...
                    width: width,
                    height: height * 0.06,
                    color: index == person.navigationButtons? Colors.purpleAccent.shade100: Colors.transparent,
                    ...
                    child: TextButton(
                      ...
                      child: Row(
                        mainAxisAlignment: person.navigationButtons == index ? 
                        MainAxisAlignment.center: MainAxisAlignment.start,
                        children: [
                          Icon(index == 0 ? Icons.space_dashboard_outlined : Icons.history_outlined,color: index == person.navigationButtons ? Colors.white : Colors.deepPurple,),
                          sizedBox(0.0, width * 0.01),
                          Text(index == 0 ? 'Dashboard' : 'Transactions',style: index == person.navigationButtons? smallTextStylewhiteBold : smallTextStyle),
                        ],
                      )),
                    ),
                  ),
   ...
   Expanded accountsManagementDashBoard(double height, double width, BuildContext context) {
    final height = MediaQuery.of(context).size.height;
    final width = MediaQuery.of(context).size.width;
    return Expanded(
              ...
              children: <Widget>[
                ...
                SingleChildScrollView(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      _buildSummaryCard('Daily Revenue', '\$12,345,000'),
                      sizedBox(0.0, width * 0.025),
                      _buildSummaryCard('Outstanding Balance', '\$321,000'),
                      sizedBox(0.0, width * 0.025),
                      _buildSummaryCard('Total Expenses', '\$56,7800'),
                      sizedBox(0.0, width * 0.038),
                    ],
                  ),
                ),
                ...
                SingleChildScrollView(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      _buildStatusCard('Today Bookings', 0.8, '80', '7,541',Colors.yellow.shade400 ,context, () {},0),
                      sizedBox(0.0, width * 0.03),
                      _buildStatusCard('Cancelled Bookings', 0.68, '68', '2,541',Colors.greenAccent, context, () {},1),
                      sizedBox(0.0, width * 0.03),
                      _buildStatusCard('Check-In', 0.39, '39', '1,154', Colors.orangeAccent.shade200, context, () {},2),
                      sizedBox(0.0, width * 0.03),
                      _buildStatusCard('Check-Out', 0.95, '95', '95',Colors.blueGrey.shade300, context, (){},3),
                      sizedBox(0.0, width * 0.02),
                    ],
                  ),
                ),
                ...
                Padding(
                  ...
                  padding: const EdgeInsets.all(16.0),
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                    Text('Revenue & Expense Report', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                    SizedBox(height: 10),
  ...
  Widget _buildStatusCard(
    String title, double progress, String count, String mobile, Color color, BuildContext context, VoidCallback onPressed, int index) {
    // final height = MediaQuery.of(context).size.height;
    // final width = MediaQuery.of(context).size.width;
    return Card(
      color: Colors.white,
