...
//           Places2(goToPage: 2, backToPage: 0, pageController: person.placesPageController),
//           MultiplePropertiesConfirmationPage(goToPage: 3, pageController: person.placesPageController, stayPalceName: 'Alternative Places'),
//           ApartmentPage2(goToPage: 4, pageController: person.placesPageController),
//           PropertyAddressPage(goToPage: 5, backToPage: 4, pageController: person.placesPageController),
//           PropertyCapacityDetailesPage(goToPage: 6, backToPage: 5, pageController: person.placesPageController),
//           PropertyLocationPage(gotToNextPage: 7, goToBackPage: 6, pageController: person.placesPageController),
//           PropertyCapacityDetailesPage(goToPage: 8, backToPage: 7, pageController: person.placesPageController),
//           PropertyAminities(goToPage: 9, backToPage: 8, pageController: person.placesPageController),
//           PropertyServices(goToPage: 10, backToPage: 9, pageController: person.placesPageController),
//           StaffLanguageSelectionPart(goToPage: 11, backToPage: 10, pageController: person.placesPageController),
//           PropertyRules(goToPage: 12, backToPage: 11, pageController: person.placesPageController),
//           HostProfilePage(goToPage: 13, backToPage: 12, pageController: person.placesPageController),
//           ImageUploader(goToPage: 14, backToPage: 13, pageController: person.placesPageController),
//           ReceiveBookings(goToPage: 15, backToPage: 14, pageController: person.placesPageController),
//           PricePerNight(goToPage: 16, backToPage: 15, pageController: person.placesPageController),
//           RatePlans(goToPage: 17, backToPage: 16, pageController: person.placesPageController),
//           Availability(goToPage: 18, backToPage: 17, pageController: person.placesPageController),
//           GoodsandServicesTsx(goToPage: 19, backToPage: 18, pageController: person.placesPageController),
//           Finalpage(goToPage: 20, backToPage: 17, pageController: person.placesPageController),
//           PropertyListing(backToPage: 18, pageController: person.placesPageController),
//         ],
//       ),
//     );
//   }
