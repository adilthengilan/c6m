...
class Apartment extends StatelessWidget {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Consumer<RegistrationProvider>(
                          ...
                          return Column(
                            children: List.generate(
                              ...
                              (index) => person.bedRoomList.isNotEmpty
                                  ? Padding(
                                        ...
                                        children: [
                                            ...
                                            child: TextButton(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  Icon(
                                                      person.bedroomBottomSheet &&
                                                              index ==
                                                                  person
                                                                      .bedRoomSelectedIndex
                                                          ? Icons
                                                              .keyboard_arrow_up
                                                          : Icons
                                                              .keyboard_arrow_down,
                                          ...
                                          person.bedroomBottomSheet &&
                                              ...
                                              ? CustomContainer(
                                                  ...
                                                  color: Colors.white,
                                                  boxShadow: true,
                                                  child: bedSelectionDropDown(
                                                      height, width, 'bedroom'),
                                                )
                                              : const SizedBox()
                                        ],
                                      ),
                        ...
                        for (int i = 0; i < 3; i++)
                          Padding(
                            padding: EdgeInsets.only(
                                bottom: height * 0.03, right: width * 0.04),
                                      ...
                                      : CustomContainer(
                                          ...
                                          child: TextButton(
                                            ...
                                            onPressed: i == 0
                                                ? () {
                                                    person
                                                        .openLivingRoomBottomSheet();
                                                  }
                                                : () {
                                                    person
                                                        .openOtherSpaceRoomBottomSheet();
                                                  },
                                            child: Row(
                                              mainAxisAlignment:
                                                  MainAxisAlignment
  ...
  Row livingRoomBedCount(
      double width, double height, RegistrationProvider person) {
    return Row(
      children: <Widget>[
