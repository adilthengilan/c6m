            ...
            CustomContainer(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Services at your property',
                  ...
                  Consumer<RegistrationProvider>(
                    ...
                    SizedBox(
                      child: consumer.serveBreakfast? Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                              ...
                              Row(
                                children: [
                                  Radio<bool>(
                                   ...
                                   Text(
                                     i == 0? "Yes, it's included" : "No, it costs extra",
                  ...
                  Consumer<RegistrationProvider>(
                    builder: (context, consumer, child) => 
                    SizedBox(
                      child: !consumer.isBrakFastIncludedCost? Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        isSelected?  Padding(
                          ...
                          child: Icon(Icons.close,size: height * 0.02,color: Colors.white,),
                        ) : const SizedBox()
                      ],
                    ),
                                          ),
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Radio<String>(
                              activeColor: Colors.lightBlueAccent,
                              value: i == 0? 'Yes, free' : i == 1? 'Yes, paid' : 'No',
