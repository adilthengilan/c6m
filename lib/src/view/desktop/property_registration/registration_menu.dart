...
//               style: GoogleFonts.montserrat(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 26),
//             ),
//             sizedBox(height * 0.02, 0.0),
//             Text(
//               'To get started, choose the type of property you want to list on Booking.com',
//               style: GoogleFonts.montserrat(fontSize: 18, color: Colors.black, fontWeight: FontWeight.w400),
//             ),
...
//                             child: Center(child: Text('Post your property', style: smallTextStylewhite)),
//                           ),
//                         ],
//                       ),
//                     ),
