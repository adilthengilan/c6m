          ...
          CustomContainer(
            ...
            child: Column(
              ...
              children: [
                ...
                Text("Cancellation policies", style: largeTextStyleBold),
                sizedBox(height * 0.03, 0.0),
                Text('How many days before arrival can guests cancel their booking for free?', style: smallTextStyleBold),
                sizedBox(height * 0.03, 0.0),
                Consumer<RegistrationProvider>(
                  builder: (context, person, child) => Column(
                    children: [
                      Row(
                        children: [
                          for (int index = 0; index < person.days.length; index++)
                            Padding(
                              padding: const EdgeInsets.symmetric(horizontal: 4.0),
                              child: ChoiceChip(
                                label: Text(person.days[index]),
                                selected: person.freeCancelationButtonIndex == index,
                                onSelected: (bool selected) {
                                  person.setCancellationPeriod(selected, index);
                                },
                                selectedColor: Colors.deepPurpleAccent,
                                backgroundColor: Colors.grey[50],
                                labelStyle: TextStyle(
                                  color: person.freeCancelationButtonIndex == index ? Colors.white : Colors.black,
                                ),
                              ),
                            ),
                        ],
                      ),
                      person.freeCancellationDaysOfBooking > 1
                          ? Container(
                              ...
                              child: Text('Allow guests to cancel up to ${person.freeCancellationDaysOfBooking} day(s) before arrival to increase your chances of getting bookings.',
                ...
                Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Guests love flexibility – free cancellation rates are generally the most booked rates on our site. Get your first booking sooner by allowing guests to cancel up to ${person.freeCancellationDaysOfBooking} days before check-in.',
                      ),
                    ),
                  ],
                ),
                sizedBox(height * 0.03, 0.0),
                Text('Protection against accidental bookings', style: smallTextStyleBold),
                    ...
                    Consumer<RegistrationProvider>(
                      builder: (context, person, child) => Row(
                        children: [
                          ...
                          Text(
                            person.isprotectionAgainstAccidentalBookings ? 'On' : 'Off',
